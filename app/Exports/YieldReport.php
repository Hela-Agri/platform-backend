...
class YieldReport implements ShouldAutoSize,WithDrawings, WithHeadings, FromArray, WithStyles, WithTitle, WithDefaultStyles
{
    ...
    public function headings(): array
    {
        ...
        return [
            [''],
            ['Date','Center','Cohort','Farmer','Contact','Farm Location',   'Yields']
        ];
    }
