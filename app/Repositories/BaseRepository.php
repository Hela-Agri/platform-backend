...
abstract class BaseRepository
{
    ...
    {
        $query = $this->allQuery();
        return $query->whereHas($attribute, $closure);
    }
    /**
     ...
     * @return bool|mixed|null
     */
    public function join($table,$column,$criteria,$column2)
    {
        $query = $this->allQuery();

        return $query->join($table,$column,$criteria,$column2);
    }
     ...
     * @return bool|mixed|null
     */
    public function withCount($string){
        $query = $this->allQuery();

        return $query->withCount($string);
    }
     ...
     * @return bool|mixed|null
     */
    public function whereDoesntHave($relationship)
    {
        $query = $this->allQuery();
        return $query->whereDoesntHave($relationship);
    }
